...
class DatasetLoad(Dataset):
    ...
    def __getitem__(self, index: int) -> Tuple[Tensor, Tensor]:
        ...
        """
        index += 1
        img_name1 = "real (" + str(index) + ").png"
        img_name2 = "fake (" + str(index) + ").png"

        cover_img = io.imread(os.path.join(self.cover, img_name1))
        stego_img = io.imread(os.path.join(self.stego, img_name2))
        # pylint: disable=E1101
